            ...
            <form action="pages/login.php" method="POST">
                <div className="row my-5">
                    ...
                    <div className="input-group">
                        ...
                        <input className="form-control p-3" name="email" type="email" placeholder="Enter email address..." required />
                    </div>
                </div>
                <div className="row my-5">
                    <span>Password</span>
                    <div className="input-group">
                        ...
                        <input className="form-control p-3" name="password" type="password" placeholder="password" required />
                    </div>
                </div>
                <div className="d-flex justify-content-center mt-4">
                    <input type="submit" className="btn btn-primary" value="Login"></input>
                </div>
                <span id="loginSwitch" className="text-white-50 mt-3">Don&apos;t have an account? <a href="#signupBox">Sign up here!</a></span>
            </form>
        </div>
    </div>
    ...
    <div id="signupBox" className="container hidden text-white bg-black p-4">
        ...
        <div className="py-3">
            <form action="pages/signup.php" method="POST">
                ...
                <span id="signupSwitch" className="text-white-50 mt-3">Already have an account? <a href="#loginBox">Login here!</a></span>
            </form>
        </div>
    </div>
</section>
